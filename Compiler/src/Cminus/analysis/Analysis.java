...
public interface Analysis extends Switch
{
    ...
    void caseAARelationalExpression(AARelationalExpression node);
    void caseABRelationalExpression(ABRelationalExpression node);
    ...
    void caseAAInputFunction(AAInputFunction node);
    void caseABInputFunction(ABInputFunction node);
    void caseAAOutputFunction(AAOutputFunction node);
    void caseABOutputFunction(ABOutputFunction node);
    void caseAAExp(AAExp node);
    void caseABExp(ABExp node);
