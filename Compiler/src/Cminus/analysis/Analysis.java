...
public interface Analysis extends Switch
{
    ...
    void caseASingleVarDec(ASingleVarDec node);
    void caseAArrayVarDec(AArrayVarDec node);
    ...
    void caseAIntImplicitTypeSpecifier(AIntImplicitTypeSpecifier node);
    void caseAStringImplicitTypeSpecifier(AStringImplicitTypeSpecifier node);
    void caseAVoidImplicitTypeSpecifier(AVoidImplicitTypeSpecifier node);
    void caseAVoidFunctionDeclaration(AVoidFunctionDeclaration node);
    void caseAArgsFunctionDeclaration(AArgsFunctionDeclaration node);
    ...
    void caseASingleParDec(ASingleParDec node);
    void caseAArrayParDec(AArrayParDec node);
