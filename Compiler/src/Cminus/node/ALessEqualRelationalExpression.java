...
public final class ALessEqualRelationalExpression extends PRelationalExpression
{
    private PExp _left_;
    private TLessEqual _lessEqual_;
    private PExp _right_;

    public ALessEqualRelationalExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ALessEqualRelationalExpression(
    ...
    {
        ((Analysis) sw).caseALessEqualRelationalExpression(this);
    }
