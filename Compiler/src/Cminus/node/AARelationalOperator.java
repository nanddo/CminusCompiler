...
public final class AARelationalOperator extends PRelationalOperator
{
    private TLessThan _lessThan_;

    public AARelationalOperator()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AARelationalOperator(
    ...
    {
        ((Analysis) sw).caseAARelationalOperator(this);
    }
