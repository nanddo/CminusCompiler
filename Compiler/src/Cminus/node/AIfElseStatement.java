...
public final class AIfElseStatement extends PIfElseStatement
{
    private TIf _if_;
    ...
    public AIfElseStatement(
        ...
        @SuppressWarnings("hiding") PStatement _false_)
    {
        // Constructor
        setIf(_if_);
    ...
    public PStatement getFalse()
    {
        return this._false_;
    }

    public void setFalse(PStatement node)
    {
