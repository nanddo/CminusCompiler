...
public final class AAAttributionStatement extends PAttributionStatement
{
    ...
    public Object clone()
    {
        return new AAAttributionStatement(
    ...
    {
        ((Analysis) sw).caseAAAttributionStatement(this);
    }
