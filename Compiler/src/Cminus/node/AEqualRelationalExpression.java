...
public final class AEqualRelationalExpression extends PRelationalExpression
{
    private PExp _left_;
    private TEqual _equal_;
    private PExp _right_;

    public AEqualRelationalExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AEqualRelationalExpression(
    ...
    {
        ((Analysis) sw).caseAEqualRelationalExpression(this);
    }
