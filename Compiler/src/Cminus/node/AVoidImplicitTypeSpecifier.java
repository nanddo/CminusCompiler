...
public final class AVoidImplicitTypeSpecifier extends PImplicitTypeSpecifier
{
    private TVoid _void_;

    public AVoidImplicitTypeSpecifier()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVoidImplicitTypeSpecifier(
    ...
    {
        ((Analysis) sw).caseAVoidImplicitTypeSpecifier(this);
    }
