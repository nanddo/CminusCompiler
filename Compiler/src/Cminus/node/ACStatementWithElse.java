...
public final class ACStatementWithElse extends PStatementWithElse
{
    private PReturnStatement _returnStatement_;

    public ACStatementWithElse()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACStatementWithElse(
    ...
    {
        ((Analysis) sw).caseACStatementWithElse(this);
    }
