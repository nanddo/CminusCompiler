...
public final class ADifferentRelationalExpression extends PRelationalExpression
{
    private PExp _left_;
    private TDifferent _different_;
    private PExp _right_;

    public ADifferentRelationalExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADifferentRelationalExpression(
    ...
    {
        ((Analysis) sw).caseADifferentRelationalExpression(this);
    }
