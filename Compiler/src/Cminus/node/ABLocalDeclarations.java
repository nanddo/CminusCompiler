...
public final class ABLocalDeclarations extends PLocalDeclarations
{
    private PEpsilon _epsilon_;

    public ABLocalDeclarations()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ABLocalDeclarations(
    ...
    {
        ((Analysis) sw).caseABLocalDeclarations(this);
    }
